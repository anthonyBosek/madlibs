...
def seed_database():
    ...
    author1 = Author.create("Alberto", "Sierra")
    author2 = Author.create("Austin", "Ohlfs")
    author3 = Author.create("Anthony", "Bosek")
